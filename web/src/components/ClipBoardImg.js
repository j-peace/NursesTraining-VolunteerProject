    ...
    return (
        <Grid item xs={5} sm={5} onClick={ props.actionClip} padding={1}>
            <Shake active={props.activeReshake}
                ...
                <Button variant="contained" style={{width: '100%', height:'3.5vw', minHeight: '45px' , boxShadow: '0px 5px 10px 0px rgba(0, 0, 0, 0.5)',  backgroundColor: '#005681', position: "static" }}  > {props.clipTitle}</Button>
            </Shake>
        </Grid>
    )
}